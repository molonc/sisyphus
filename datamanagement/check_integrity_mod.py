...
def main(
    ...
    if all_file_instances:
        #file_resources = tantalus_api.list('file_resource', fileinstance__storage__name="singlecellblob", filename__startswith="single_cell_indexing/fastq/A118417A")
        print("cool beans")
        file_resources = tantalus_api.list('file_resource', fileinstance__storage__name="singlecellblob", filename__startswith="single_cell_indexing/fastq/A118403B")
