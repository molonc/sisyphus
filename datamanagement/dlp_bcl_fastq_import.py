...
def add_lanes(flowcell_id, lane_count):
    ...
    for lane_number in range(1, 1+int(lane_count)):
...
@click.argument('lane_count',nargs=1, type=int)
...
def main(
    ...
    if not no_bcl2fastq:
        ...
        # add 4 lanes generated by bcl2fastq on colossus in order to be picked up for analysis
        add_lanes(flowcell_id, lane_count)
